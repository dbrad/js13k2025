...
declare const TEXTURE_C_4x4: 1;
declare const TEXTURE_C_5x5: 2;
declare const TEXTURE_C_6x6: 3;
declare const TEXTURE_C_7x7: 4;
declare const TEXTURE_C_8x8: 5;
declare const TEXTURE_C_16x16: 6;
declare const TEXTURE_D_PAD: 7;
declare const TEXTURE_D_PAD_UP: 8;
declare const TEXTURE_D_PAD_RIGHT: 9;
declare const TEXTURE_A_BUTTON_UP: 10;
...
declare const UP_FOOL: 6;
declare const UP_MAGI: 7;
declare const UP_PRST: 8;
declare const UP_EMPS: 9;
declare const UP_EMPR: 10;
declare const UP_HIERO: 11;
declare const UP_LOVER: 12;
declare const UP_CHARI: 13;
declare const UP_STR: 14;
declare const UP_HERM: 15;
declare const UP_WHEEL: 16;
declare const UP_JUST: 17;
declare const UP_HANG: 18;
declare const UP_DEATH: 19;
declare const UP_TEMPER: 20;
declare const UP_DEVIL: 21;
declare const UP_TOWER: 22;
declare const UP_STAR: 23;
declare const UP_MOON: 24;
declare const UP_SUN: 25;
declare const UP_JUDGE: 26;
declare const UP_WORLD: 27;
